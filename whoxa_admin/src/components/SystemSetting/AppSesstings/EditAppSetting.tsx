...
function EditwebsiteSettings() {
        ...
        const fetchSettings = async () => {
            try {
                ...
                if (response.success) {
                    ...
                    if (settings) {
                        const { app_name, app_logo, app_text, app_color_primary, app_color_secondary, website_logo, app_email, setting_id, app_link, ios_link, android_link, tell_a_friend_link } = settings[0];
    ...
    }, [appName, appText, appColorPrimary, appColorSecondary, selectedLogo, initialValues, appEmail, appLink, androidLink, iosLink, tellFriendLink]);
                        ...
                        <div className="flex flex-col gap-y-8 mt-5">
                            ...
                            {previewLogo || currentLogo ? (
                                <div className="relative w-full sm:w-64 inline-block">
                                    <label className="font-bold">Applogo Preview:</label>
