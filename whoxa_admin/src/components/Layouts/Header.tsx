...
import { clearAdminDetails } from "../../store/adminSlice";
...
const Header = () => {
  ...
  const handleLogout = () => {
    ...
    dispatch(clearAdminDetails()); // Clear admin details from Redux state and localStorage
    navigate("/auth/boxed-signin"); // Navigate to the login page
  };
  return (
    <header
      className={`z-40 ${
        ...
        <div className="relative bg-white flex w-full items-center px-5 py-2.5 dark:bg-black">
          <div className="horizontal-logo flex lg:hidden justify-between items-center ltr:mr-2 rtl:ml-2">
            <Link to="/" className="main-logo flex items-center shrink-0">
              <img
                className="w-11 ltr:-ml-1 rtl:-mr-1 inline"
          ...
          <div className="sm:flex-1 ltr:sm:ml-0 ltr:ml-auto sm:rtl:mr-0 rtl:mr-auto flex items-center justify-end space-x-1.5 lg:space-x-2 rtl:space-x-reverse dark:text-[#d0d2d6]">
            ...
            <NotificationDropdown isRtl={false} />
          ...
          <li className="menu nav-item relative">
            ...
            <ul className="sub-menu">
              <li className="relative">
                ...
                <ul className="rounded absolute top-0 ltr:left-[95%] rtl:right-[95%] min-w-[180px] bg-white z-[10] text-dark dark:text-white-dark dark:bg-[#1b2e4b] shadow p-0 py-2 hidden">
                  <li>
                    <NavLink to="/admin/users/profile">{t("profile")}</NavLink>
                  </li>
                  <li>
                    <NavLink to="/admin/users/user-account-settings">
                      {t("account_settings")}
                    </NavLink>
                  </li>
                </ul>
