        ...
        >
          <div>
            <div
              ...
              } group relative overflow-hidden flex w-fit min-w-[1rem] max-w-[17rem] flex-col rounded-lg px-2 py-1 text-sm sm:max-w-xl 2xl:max-w-3xl`}
            >
              ...
              <div className="flex h-full w-full">
                {
                  <>
                    {messageData.delete_from_everyone === true ? (
                        ...
                        <LoadingSkeletonImageDynamic
                          ...
                          className={` ${
                            messageData.myMessage
                              ? "rounded-br-none"
                              : "rounded-bl-none"
                          } min-h-44 min-w-60 cursor-pointer select-none rounded-lg object-cover transition-all duration-300 lg:h-56 lg:w-96`}
                          image_height=""
                        ...
                        <LoadingSkeletonImageDynamic
                          ...
                          className={` ${
                            messageData.myMessage
                              ? "rounded-br-none"
                              : "rounded-bl-none"
                          } h-44 w-[17rem] cursor-pointer select-none rounded-lg object-cover transition-all duration-300 lg:h-56 lg:w-96`}
                          image_height=""
                          image_url={messageData.url}
                          image_width=""
                        />
                      ...
                      <div
                        ...
                        className={` ${
                          messageData.myMessage
                            ? "rounded-br-none"
                            : "rounded-bl-none"
                        } relative h-44 w-60 cursor-pointer overflow-hidden rounded-lg lg:h-56 lg:w-96`}
                      >
                        ...
                        <LoadingSkeletonImageDynamic
                          radius=""
                          className={`h-44 select-none object-cover lg:h-56 lg:w-96`}
                          image_height="100%"
                      ...
                      <div
                        className={`w-full max-w-80 rounded-[9px] ${messageData.myMessage ? "primary-gradient rounded-br-none" : "rounded-bl-none bg-pdfBg"} px-1 pb-3 pt-1 lg:min-w-80`}
                      >
                        <a
                      ...
                      <div
                        className={`h-52 w-full max-w-80 rounded-[9px] ${messageData.myMessage ? "primary-gradient rounded-br-none" : "rounded-bl-none bg-pdfBg"} pt-1 min-w-64 sm:min-w-80`}
                      >
            ...
            <div
              className={`flex ${messageData.myMessage ? "justify-end" : "justify-start"} mt-1 items-center gap-x-2`}
            >
              ...
              {messageData.myMessage && (
                <LiaCheckDoubleSolid
                  title={messageData.message_read == 1 ? "Seen" : "Unseen"}
                  className={`h-5 w-5 ${
