...
export default function AddMemberToGroup() {
  ...
  return (
    <div className="relative flex h-screen min-w-80 flex-col bg-secondary pb-0 pt-6 shadow-inner lg:pt-16 2xl:min-w-96">
      ...
      {/* <Button
        ...
        text={CreateGroup.public_group ? "Public Group" : "Private Group"}
      /> */}
      <SelectedContact />
