...
// console.log(CreateGroup.user_id.length,"CreateGroup.user_id.length");

  return (
    <>
      {CreateGroup.user_id.length !== 0 && (
        <>
          <div className="flex min-h-28 lg:max-w-96 items-center gap-2 overflow-hidden overflow-x-auto px-3 py-3 text-center 2xl:max-w-96">
                ...
                return (
                  ...
                  >
                    <div className="relative">
                      <img
                        className="h-10 w-10 object-cover rounded-full xl:h-12 xl:w-12"
